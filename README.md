...
### Инструкция для получения ответа на вопрос по своему тексту, используя наш сервер с моделью
Получить результаты работы модели можно двумя способами
- Используя графическую оболочку
- Через cmd
